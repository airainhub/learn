...
g_funs.prototype.timestamp_format = function(time){
...
g_funs.prototype.get_local_ip = function (callback){  
    http.get("http://getip.aodianyun.com:50000/?cmd=GetSelfIp", function(res) { 
...
g_funs.prototype.de_unicode = function(str){  
    str = str.replace(/\\/g, "%");  
    return unescape(str);  
};
