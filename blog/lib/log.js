...
var Logger = function( logFilePath ) 
{
	//if (logFilePath) 
	//{
		//创建Log文件夹，如果Log文件已存在就直接在该文件夹中创建日志文件
		//var logFolderPath = logFilePath.substr( 0, logFilePath.lastIndexOf('/') );
		//fs.mkdir(logFolderPath, 0777, function (err) 
		//{
			//if (err) 
			//{
				//if(err.code !='EEXIST')
				//{
					//console.log("log directory create error: " + err.code);
				//}
			//}
			//else 
			//{
				//console.log('log directory create success');
			//}
		//});
